...
## Usage
The initial player will chose a color. Players will then alternate taking turns, moving their pieces by typing the source and destination coordinates. The game ends when a player is in checkmate
